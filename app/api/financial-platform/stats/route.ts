...
export async function GET() {
  ...
  const transparency = await fetchTransparencyDonations({ limit: 20 });
  const resources = await fetchFinancialResourcesFromDb();
