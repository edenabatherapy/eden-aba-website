...
export const PATH_PAGE_ROUTES = {
  ...
  "/resources/financial-assistance": "financial-assistance",
  ...
  "/services/center-based-aba-therapy": "center-based-aba-therapy",
  "/services/home-based-aba-therapy": "home-based-aba-therapy",
  "/services/in-home-aba-therapy": "home-based-aba-therapy",
  "/services/community-based-aba-therapy": "community-based-aba-therapy",
  "/services/virtual-aba-therapy": "virtual-aba-therapy",
  "/services/after-school-programs": "afterschool-programs",
  "/services/aba-therapy": "aba-therapy",
  ...
  "/providers": "providers",
  "/providers/refer-a-child": "providers-refer-a-child",
  "/providers/referral-process": "providers-referral-process",
  "/providers/clinical-collaboration": "providers-clinical-collaboration",
...
export const KNOWN_PAGES = new Set([
  ...
  "careers-resources",
  "providers",
  "providers-refer-a-child",
  "providers-referral-process",
  "providers-clinical-collaboration",
]);
...
export function applyPageToBrowserUrl(page, { pathOverride, scrollTo } = {}) {
  ...
  if (
    ...
    destination?.startsWith("/providers") ||
