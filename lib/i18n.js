...
import homeBasedAbaVi from "@/locales/partials/home-based-aba-vi.json";
...
import speechLanguageScreeningEn from "@/locales/partials/speech-language-screening-en.json";
import speechLanguageScreeningVi from "@/locales/partials/speech-language-screening-vi.json";
...
const homeBasedAbaCatalogs = {
  en: homeBasedAbaEn,
  vi: homeBasedAbaVi,
};

const speechLanguageScreeningCatalogs = {
  en: speechLanguageScreeningEn,
  vi: speechLanguageScreeningVi,
};
...
export function deepMerge(base, overlay) {
  if (Array.isArray(base) && Array.isArray(overlay)) {
    return base.map((item, index) => {
      ...
      if (overlayItem === undefined) return item;
...
export function getTranslation(language) {
  ...
  catalog.pages = {
    ...catalog.pages,
    homeBasedAbaTherapy: deepMerge(
      catalog.pages.homeBasedAbaTherapy,
      homeBasedAbaCatalogs[lang] || homeBasedAbaCatalogs.en,
    ),
    speechLanguageScreening: deepMerge(
      speechLanguageScreeningCatalogs.en,
      speechLanguageScreeningCatalogs[lang] || {},
    ),
  };
