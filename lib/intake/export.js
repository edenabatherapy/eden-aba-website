...
export function exportFullPacket(data, meta) {
  return {
    ...
    intake: prepareIntakePayload(data),
 ...
 */
export async function submitIntake(data, meta, files = {}, recaptchaToken = null) {
  const prepared = prepareIntakePayload(data);
  const formData = new FormData();
  formData.append("intake", JSON.stringify(prepared));
