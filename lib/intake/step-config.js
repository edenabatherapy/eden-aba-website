...
import { getMinimalRequiredFieldsForStep } from './required-fields.js';
    ...
    sections: [
      {
        ...
        icon: "👤",
        fields: [
          { name: "childFullName", label: "Child First Name", type: "text", placeholder: "First name (last name optional)" },
...
export function getStepRequiredFields(stepIndex, _data = {}) {
  return getMinimalRequiredFieldsForStep(stepIndex);
}

export { isIntakeFieldRequired } from "./required-fields.js";
