...
export const MENU_LINK_ROUTES = {
  ...
  "Contact Us": { action: "navigate", page: "about-contact-us", path: "/contact" },
  "Câu chuyện của chúng tôi": { action: "navigate", page: "about-us", path: "/about/our-story" },
  "Sứ mệnh & Giá trị": {
    action: "navigate",
    page: "about-mission-values",
    path: "/about/mission-values",
  ...
  "Liên hệ": { action: "navigate", page: "about-contact-us", path: "/contact" },
  ...
  "Center-Based ABA Therapy": {
    ...
    path: "/services/center-based-aba-therapy",
  },
  "Home-Based ABA Therapy": {
    action: "navigate",
    page: "home-based-aba-therapy",
    path: "/services/home-based-aba-therapy",
  },
  "In-Home ABA Therapy": {
    action: "navigate",
    page: "in-home-aba-therapy",
    path: "/services/in-home-aba-therapy",
  },
  "Community-Based ABA Therapy": {
    action: "navigate",
    page: "community-based-aba-therapy",
    path: "/services/community-based-aba-therapy",
  },
  ...
  "Virtual ABA Therapy": {
    ...
    path: "/services/virtual-aba-therapy",
  },
  "After School Programs": {
    action: "navigate",
    page: "afterschool-programs",
    path: "/services/after-school-programs",
  },
  "ABA Therapy": {
    action: "navigate",
    page: "aba-therapy",
  ...
  "Early Intervention ABA Therapy": {
    action: "navigate",
    page: "early-intervention-aba-therapy",
    path: "/services/early-intervention-aba-therapy",
  },
  "Behavior Assessment": {
    action: "navigate",
    page: "behavior-assessment",
    path: "/services/behavior-assessment",
  },
  "Individualized ABA Programs": {
    action: "navigate",
    page: "individualized-aba-programs",
    path: "/services/individualized-aba-programs",
  },
  "Social Skills Training": {
    action: "navigate",
    page: "social-skills-training",
    path: "/services/social-skills-training",
  },
  "Parent Training & Support": {
    action: "navigate",
    page: "parent-training-support",
    path: "/services/parent-training-support",
  },
  "Occupational Therapy": {
    action: "navigate",
    page: "occupational-therapy",
    path: "/services/occupational-therapy",
  },
  "Speech & Language Therapy": {
    action: "navigate",
    page: "speech-language-therapy",
    path: "/services/speech-language-therapy",
  },
  "Feeding & Swallowing Therapy": {
    action: "navigate",
    page: "feeding-swallowing-therapy",
    path: "/services/feeding-swallowing-therapy",
  },
  "Trị liệu hoạt động": {
    action: "navigate",
    page: "occupational-therapy",
  ...
  "Liệu pháp ABA tại nhà (Home-Based)": {
    action: "navigate",
    page: "home-based-aba-therapy",
    path: "/services/home-based-aba-therapy",
  },
  "Liệu pháp ABA tại nhà (In-Home)": {
    action: "navigate",
    page: "in-home-aba-therapy",
    path: "/services/in-home-aba-therapy",
  },
  ...
  "Refer a Child": { action: "navigate", page: "providers-refer-a-child", path: "/providers/refer-a-child" },
  "Provider Referral Portal": {
    action: "navigate",
    page: "providers-refer-a-child",
    path: "/providers/refer-a-child",
  },
  "CentralReach Staff Login": {
    action: "external",
    url: "https://app.cressentials.com/users/sign_in",
  },
  "Referral Process": {
    action: "navigate",
    page: "providers-referral-process",
    path: "/providers/referral-process",
  },
  "Clinical Collaboration": {
    action: "navigate",
    page: "providers-clinical-collaboration",
    path: "/providers/clinical-collaboration",
  },
  "Autism Screening Support": {
    action: "navigate",
    page: "providers",
    path: "/providers#autism-screening-support",
  },
  "Insurance & Intake Coordination": {
    action: "navigate",
    page: "providers",
    path: "/providers#insurance-intake-coordination",
  },
  "For Providers": { action: "navigate", page: "providers", path: "/providers" },
};
