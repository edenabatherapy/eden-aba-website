...
export default function BtStickyApplyBar() {
  const [visible, setVisible] = useState(false);

  useEffect(() => {
    const hero = document.getElementById("bt-hero-section");
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 border-t border-lime-200 bg-white/95 px-4 py-3 shadow-[0_-8px_30px_rgba(15,23,42,0.08)] backdrop-blur-md lg:hidden"
      role="region"
