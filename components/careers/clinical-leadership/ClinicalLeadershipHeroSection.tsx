...
export default function ClinicalLeadershipHeroSection() {
  ...
  return (
    <section
      id="cl-hero-section"
      className="relative overflow-hidden bg-gradient-to-br from-[#e8f4f8] via-white to-[#f0f9f4] px-4 py-14 lg:px-8 lg:py-20"
      aria-labelledby="cl-hero-heading"
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
        <div>
          ...
          >
            Clinical Leadership Opportunities at Eden
          </motion.h1>
          <motion.p {...fade(0.16)} className="mt-5 max-w-xl text-lg leading-8 text-slate-600">
            Lead quality care, develop clinical teams, strengthen treatment integrity, and help shape the future of
            autism services across Northern Virginia.
          </motion.p>
          <motion.p {...fade(0.2)} className="mt-4 max-w-xl text-sm leading-7 text-slate-500">
            From Clinical Quality Supervisor to Regional Clinical Director, leadership roles center on quality,
          ...
          <motion.div {...fade(0.32)} className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link href="/careers/open-roles" className={getButtonClasses("primary", "w-full sm:w-auto")}>
              View Leadership Roles
              <ArrowRight size={18} aria-hidden="true" />
            </Link>
            <Link href="#cl-leadership-pathways" className={getButtonClasses("secondary", "w-full sm:w-auto")}>
        ...
        <motion.aside
          ...
          aria-label="Your leadership impact at Eden"
        >
          <p className="text-xs font-black uppercase tracking-[0.14em] text-teal-800">Your Leadership Impact</p>
