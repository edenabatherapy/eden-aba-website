...
import { BCBA_GROWTH_LADDER_DETAILED } from "@/lib/careers/bcba-careers-data";
...
export default function BcbaGrowthPathSection() {
  ...
  return (
    <RbtScrollReveal>
      <section
        ...
        aria-labelledby="bcba-growth-path-heading"
      >
        <h2 id="bcba-growth-path-heading" className="text-2xl font-extrabold text-slate-900 sm:text-3xl">
          Clinical career progression at Eden
        </h2>
        <p className="mt-3 max-w-2xl text-base leading-8 text-slate-600">
          Most clinicians progress from direct care through BCBA responsibility. Advancement depends on credential
          eligibility, performance, mentorship, and organizational needs—not guaranteed timelines.
        </p>

        <div className="mt-10 flex flex-col items-center">
          {BCBA_GROWTH_LADDER_DETAILED.map((step, index) => (
            <div key={step.title} className="flex w-full max-w-xl flex-col items-center">
              ...
              {index < BCBA_GROWTH_LADDER_DETAILED.length - 1 && (
        ...
        <div className="mt-8 text-center sm:text-left">
          <Link
            ...
            className={getButtonClasses("secondary", "inline-flex")}
          >
            Explore advanced career paths
