    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <motion.div {...fadeUp} className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg font-semibold leading-8 text-emerald-800 dark:text-emerald-200">
            {content.subheadline}
          </p>
        </motion.div>
        ...
        <div className="mt-14 grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.08 }}>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <CtaLink href={content.primaryCtaHref} className="w-full sm:w-auto">
                {content.primaryCta}
                <ArrowRight size={18} aria-hidden="true" />
              </CtaLink>
              <CtaLink href={content.secondaryCtaHref} variant="secondary" className="w-full sm:w-auto">
          ...
          <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.14 }} className="relative">
            <div className="overflow-hidden rounded-[2rem] shadow-2xl shadow-emerald-950/10 ring-1 ring-emerald-100 dark:ring-emerald-900/40">
              <img
                ...
                alt="Eden ABA Therapy team environment focused on compassionate, family-centered autism care"
