        ...
        >
          {content.highlights.map((highlight) => (
            <motion.div key={highlight} variants={staggerItem}>
              <Card className="h-full border-emerald-100 transition duration-300 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-xl dark:border-slate-700 dark:bg-slate-900">
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="mt-3 text-lg">{highlight}</CardTitle>
                </CardHeader>
              </Card>
            </motion.div>
          ))}
